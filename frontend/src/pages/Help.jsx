      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            ...
            <a href="https://wa.me/6282340074645" target="_blank" rel="noreferrer" className="block bg-white rounded-xl shadow-sm border border-green-100 p-6 hover:shadow-md transition-shadow group">
            ...
            <a href="tel:+6282340074645" className="block bg-white rounded-xl shadow-sm border border-blue-100 p-6 hover:shadow-md transition-shadow group">
              <div className="flex items-center gap-4 mb-3">
                ...
                <div>
                  ...
                  <p className="text-blue-600 text-sm font-semibold">+62 823-4007-4645</p>
                </div>
              </div>
              <p className="text-gray-500 text-sm">Bicarakan masalah Anda langsung dengan agen dukungan kami.</p>
            </a>
            
            <a href="mailto:support@nabilatrans.com" className="block bg-white rounded-xl shadow-sm border border-orange-100 p-6 hover:shadow-md transition-shadow group">
              <div className="flex items-center gap-4 mb-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 text-lg">Email Dukungan</h3>
                  <p className="text-orange-500 text-sm font-semibold">support@nabilatrans.com</p>
                </div>
              </div>
              <p className="text-gray-500 text-sm">Kirim keluhan atau klaim asuransi beserta file lampiran Anda.</p>
            </a>
          </div>
        </div>
      </div>
