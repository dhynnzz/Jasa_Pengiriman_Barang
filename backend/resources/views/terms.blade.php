<x-layout>
    ...
    <div class="bg-blue-950 pt-32 pb-20 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-6">Ketentuan Layanan</h1>
            <p class="text-xl text-blue-200">Syarat dan ketentuan yang berlaku dalam penggunaan layanan CV Nabila Trans.</p>
        </div>
    </div>

    <!-- Content Section -->
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 prose prose-blue max-w-none">
            
            <p class="text-gray-500 mb-8">Pembaruan Terakhir: 15 Agustus 2023</p>

            <h2 class="text-2xl font-bold text-blue-950 mb-4">1. Penerimaan Syarat</h2>
            ...
            <h2 class="text-2xl font-bold text-blue-950 mb-4">2. Layanan Pengiriman</h2>
            ...
            <h2 class="text-2xl font-bold text-blue-950 mb-4">3. Tanggung Jawab & Asuransi</h2>
            <p class="text-gray-600 mb-6 leading-relaxed">
            ...
            <h2 class="text-2xl font-bold text-blue-950 mb-4">4. Kebijakan Privasi</h2>
            <p class="text-gray-600 mb-6 leading-relaxed">
            ...
            <h2 class="text-2xl font-bold text-blue-950 mb-4">5. Perubahan Ketentuan</h2>
            <p class="text-gray-600 mb-6 leading-relaxed">
            ...
            <div class="mt-12 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <h3 class="text-lg font-bold text-blue-950 mb-2">Punya Pertanyaan?</h3>
                <p class="text-gray-600">Jika Anda memiliki pertanyaan terkait ketentuan layanan kami, silakan hubungi tim dukungan kami melalui <a href="#" class="text-orange-500 font-semibold hover:underline">support@nabilatrans.com</a> atau telepon ke kantor pusat kami.</p>
            </div>
        </div>
    </div>
</x-layout>
