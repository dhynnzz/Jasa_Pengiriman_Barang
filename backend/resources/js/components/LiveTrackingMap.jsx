...
// Let's just create a simplified polyline
...
// A component to recenter the map on the truck initially
const MapController = ({ currentPos }) => {
    const map = useMap();
    useEffect(() => {
        // Just recenter slightly off so we can see the origin
    ...
    return (
        <div className="w-full h-full relative z-0">
            ...
            >
                ...
                <MapController currentPos={[-6.8, 109.5]} />
            </MapContainer>
        </div>
    );
};
